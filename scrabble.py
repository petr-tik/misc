...
class TestScrabble(unittest.TestCase):
    ...
    def test_queue_is_high_score(self):
        """ testing that letters below give queue as max_word """
        letters = ['q', 'u', 'u', 'e', 'e', 'r']
        words = generate_words_brute(letters)
        w, val =  find_max_word_and_score(words)
        self.assertEqual(("queue", 72), (w, val))
    ...
    def test_dfs_and_brute_amazon(self):
        """ testing that same words are generated by both methods """
        amazon = ['a', 'm', 'a', 'z', 'o', 'n']
